...
# ── Base directory (works on both local and cloud) ──
...
def create_vector_store(chunks):
    """
    Convert chunks into embeddings using
    full local HuggingFace model.
    No RAM restrictions — full quality!
    """
    print("\nLoading embedding model...")
    print("  (Downloading model first time — ~90MB)")
...
if __name__ == "__main__":
    ...
    print("Next step: Run python src/agent.py")